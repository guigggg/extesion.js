        ...
        commands: {
            ...
            cookieCommand: {
                ...
                cookies: ['deu-lhe um biscoito de chocolate!',
                    'deu-lhe um biscoito de aveia caseiro e macio!',
                    'deu-lhe o ultimo biscoito do pacote',
                    'deu-lhe um biscoito seco e velho!',
                    'deu-lhe um biscoito mofado',
                    'deu-lhe um biscoito de menta, que biscoito estranho!',
                    'deu-lhe um biscoito da sorte. Que esta escrito: "Por que você não está trabalhando em seus projeto?"',
                    'deu-lhe um biscoito da sorte. Que esta escrito: "Nossa como você é lindo(a)!"',
                    'deu-lhe um biscoito da sorte. Que esta escrito: "Você esta correndo risco, Fuja agora!"',
                    'deu-lhe um biscoito da sorte. Que esta escrito: "Saia daqui."',
                    'deu-lhe um biscoito da sorte. Que esta escrito: "Não se esqueça de comer seus vegetais!"',
                    'deu-lhe um biscoito da sorte. Que esta escrito: "olhe para trás!"',
                    'deu-lhe um biscoito da sorte. Que esta escrito: "Hu3Hu3Hu3BRBRBRBR"',
                    'deu-lhe um biscoito da sorte. Que esta escrito: "Seria legal se você dançasse de vez em quanto!"',
                    'deu-lhe um biscoito da sorte. Que esta escrito: "Eu amo voçe."',
                    'deu-lhe um biscoito de Ouro. Você pode não comê-lo porque ele é feito de ouro. Droga.',
                    'deu-lhe um biscoito Oreo com um copo de leite!',
                    'deu-lhe um biscoito arco-íris feito com amor :heart:',
                    'deu-lhe um biscoito velho, que foi deixado na chuva, e esta mofado.',
                    'assou biscoitos de chocolates, Hummmmm o cheiro é maravilhoso.'
                ],
                getCookie: function () {
